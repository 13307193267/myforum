...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
						           {"menuid":"1","icon":"icon-add","menuname":"生活详情",
							      "menus":[
									{"menuid":"12","menuname":"网页","icon":"icon-add","url":"../page/login.jsp"},
									{"menuid":"13","menuname":"我的余额","icon":"icon-add","url":"../page/balance.jsp"},
									{"menuid":"14","menuname":"柱状图","icon":"icon-role","url":"../page/test.jsp"},
									{"menuid":"15","menuname":"饼状图","icon":"icon-set","url":"../page/bzt.jsp"},
									{"menuid":"16","menuname":"折线图","icon":"icon-log","url":"../page/zxt.jsp"}
								    ]},
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体"> <span style="float:right; padding-right:20px;" class="head">${user.username},欢迎您 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span> <span style="padding-left:10px; font-size: 16px; "><img src="images/blocks.gif" width="20" height="20" align="absmiddle" />项目管理系统</span> </div>
